...
public class GazePlotter : MonoBehaviour
{
    ...
    private void UpdateGazePointCloud(GazePoint gazePoint)
    {
		...
		/*
		var pointCloudSprite2 = new GameObject("PointCloudSprite t");
		var spriteRenderer2 = pointCloudSprite2.AddComponent<SpriteRenderer>();
		spriteRenderer2.sprite = PointSprite;

		pointCloudSprite2.transform.position = ProjectToPlaneInWorld(gazePoint);

		//Set the alpha of the sprite
		Color c = pointCloudSprite2.GetComponent<SpriteRenderer> ().color;
		c.a = 0.2f;
		pointCloudSprite2.GetComponent<SpriteRenderer> ().color = c;
		*/
    }
